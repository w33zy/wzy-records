...
/**
 * wzy_Records Callback Helper Class
 *
 ...
 */
class wzy_Records_Callback_Helper {
	...
	private function get_id_attribute( $id ) {
		return ' id="wzy_records_settings[' . $id . ']" ';
	}

	private function get_name_attribute( $name ) {
		return ' name="wzy_records_settings[' . $name . ']" ';
	}
	...
	private function get_label_for( $id, $desc ) {
		return '<label for="wzy_records_settings[' . $id . ']"> '  . $desc . '</label>';
	}
	...
	public function checkbox_callback( $args ) {
		...
		$value = wzy_Records_Option::get_option( $args['id'] );
	...
	public function multicheck_callback( $args ) {
		...
		$old_values = wzy_Records_Option::get_option( $args['id'], array() );
	...
	public function radio_callback( $args ) {
		...
		$old_value = wzy_Records_Option::get_option( $args['id'] );
	...
	private function input_type_callback( $type, $args ) {
		...
		$value = wzy_Records_Option::get_option( $args['id'], $args['std']  );
