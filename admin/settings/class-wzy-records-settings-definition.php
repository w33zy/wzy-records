 ...
 */
class wzy_Records_Settings_Definition {

	// @TODO: change plugin-name
	public static $plugin_name = 'wzy-records';
	...
	static private function apply_tab_slug_filters( $default_settings ) {
		...
		foreach ( $extended_tabs as $tab_slug => $tab_desc ) {
			...
			$extended_settings[ $tab_slug ] = apply_filters( 'wzy_records_settings_' . $tab_slug, $options );
		}
	...
	static public function get_tabs() {
		...
		return apply_filters( 'wzy_records_settings_tabs', $tabs );
	}
